    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-black">
            <div className="relative w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-900 rounded-2xl shadow-lg">
                ...
                <div>
                    <h1 className="text-3xl font-extrabold text-center">Welcome Back to Xylax AI</h1>
                ...
                <p className="mt-8 text-center text-sm">
                    ...
                    <button onClick={onNavigateToSignUp} className="font-medium text-pink-500 hover:text-pink-400">
                        Sign up
                    </button>
                </p>
            </div>
